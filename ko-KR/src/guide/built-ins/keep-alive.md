&lt;script setup&gt; import SwitchComponent from './keep-alive-demos/SwitchComponent.vue' &lt;/script&gt;
...
<p data-md-type="paragraph">kept-alive 컴포넌트는 <a href="/api/composition-api-lifecycle.html#onactivated" data-md-type="link"><code data-md-type="codespan">onActivated()</code></a> 및 <a href="/api/composition-api-lifecycle.html#ondeactivated" data-md-type="link"><code data-md-type="codespan">onDeactivated()</code></a> )를 사용하여 이 두 가지 상태에 대한 라이프사이클 훅을 등록할 수 있습니다.</p>
...
<p data-md-type="paragraph">kept-alive 컴포넌트는 <a href="/api/options-lifecycle.html#activated" data-md-type="link"><code data-md-type="codespan">activated</code></a>  훅과<a href="/api/options-lifecycle.html#deactivated" data-md-type="link"><code data-md-type="codespan">deactivated</code></a> 훅를 사용하여 다음 두 가지 상태에 대한 라이프사이클 훅을 등록할 수 있습니다.</p>
